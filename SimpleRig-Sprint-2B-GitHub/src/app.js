...
const els={canvas:$("mainCanvas"),projectName:$("projectName"),gagName:$("gagName"),undoBtn:$("undoBtn"),redoBtn:$("redoBtn"),saveBtn:$("saveBtn"),openInput:$("openInput"),sceneList:$("sceneList"),emptySelection:$("emptySelection"),selectionEditor:$("selectionEditor"),objectLabel:$("objectLabel"),objectX:$("objectX"),objectY:$("objectY"),objectZ:$("objectZ"),objectRotation:$("objectRotation"),objectScale:$("objectScale"),duplicateBtn:$("duplicateBtn"),deleteBtn:$("deleteBtn"),status:$("status"),viewBadge:$("viewBadge"),clearSketchBtn:$("clearSketchBtn"),recognitionToggle:$("recognitionToggle"),recognitionCard:$("recognitionCard"),recognitionLabel:$("recognitionLabel"),recognitionConfidence:$("recognitionConfidence"),convertRecognitionBtn:$("convertRecognitionBtn"),keepRecognitionBtn:$("keepRecognitionBtn")};
